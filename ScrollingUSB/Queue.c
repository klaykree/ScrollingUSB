...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, ScrollingUSBQueueInitialize)
#endif

NTSTATUS
ScrollingUSBQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = ScrollingUSBEvtIoDeviceControl;
    queueConfig.EvtIoStop = ScrollingUSBEvtIoStop;
...
VOID
ScrollingUSBEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
